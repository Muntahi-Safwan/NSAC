...
const Home = () => {
  return (
    <>
      ...
      <div className="relative min-h-0 md:min-h-0 lg:min-h-[80vh] flex flex-col py-6 sm:py-8">

        {/* Content Container - Flex Layout */}
        <div className="relative z-10 flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8">
